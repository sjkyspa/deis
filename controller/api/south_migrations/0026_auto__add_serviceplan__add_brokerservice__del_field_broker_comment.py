...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_serviceplan', (
            ('uuid', self.gf('api.fields.UuidField')(unique=True, max_length=32, primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.BrokerService'])),
            ('id', self.gf('django.db.models.fields.TextField')(unique=True)),
        ...
        db.send_create_signal(u'api', ['ServicePlan'])

        # Adding model 'BrokerService'
        db.create_table(u'api_brokerservice', (
            ('uuid', self.gf('api.fields.UuidField')(unique=True, max_length=32, primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('broker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Broker'])),
            ('id', self.gf('django.db.models.fields.TextField')(unique=True)),
            ('name', self.gf('django.db.models.fields.TextField')(unique=True)),
            ('description', self.gf('django.db.models.fields.TextField')(unique=True)),
        ))
        db.send_create_signal(u'api', ['BrokerService'])

        # Deleting field 'Broker.comment'
        db.delete_column(u'api_broker', 'comment')


    def backwards(self, orm):
        # Deleting model 'ServicePlan'
        db.delete_table(u'api_serviceplan')

        # Deleting model 'BrokerService'
        db.delete_table(u'api_brokerservice')

        # Adding field 'Broker.comment'
        db.add_column(u'api_broker', 'comment',
    ...
    models = {
        u'api.app': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'wilder-zoologer'", 'unique': 'True', 'max_length': '64'}),
        ...
        u'api.brokerservice': {
            ...
            'id': ('django.db.models.fields.TextField', [], {'unique': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'unique': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('api.fields.UuidField', [], {'unique': 'True', 'max_length': '32', 'primary_key': 'True'})
        },
        ...
        u'api.serviceplan': {
            ...
            'id': ('django.db.models.fields.TextField', [], {'unique': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'unique': 'True'}),
            'service': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.BrokerService']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('api.fields.UuidField', [], {'unique': 'True', 'max_length': '32', 'primary_key': 'True'})
        },
        u'auth.group': {
